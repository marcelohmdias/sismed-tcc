    ...
    <v-container grid-list-lg>
      <v-layout row wrap>
        ...
        <v-flex xs12>
          <f-field
            name="generic_name"
            :validate="validate('error.required.generic_name', required)"
          >
            <template slot-scope="props">
              <v-text-field
                :name="props.name"
                :label="$t('page.record.form.generic_name')"
                :rules="checkError(props.meta)"
                :value="props.value"
                v-on="props.events"
                type="text"
        ...
        <v-flex xs12>
          <f-field
            name="factory_name"
            :validate="validate('error.required.factory_name', required)"
          >
            <template slot-scope="props">
              <v-text-field
                :name="props.name"
                :label="$t('page.record.form.factory_name')"
                :rules="checkError(props.meta)"
                :value="props.value"
                v-on="props.events"
                type="text"
        ...
        <v-flex xs12>
          <f-field name="manufacturer">
            <template slot-scope="props">
              <v-text-field
                :name="props.name"
                :label="$t('page.record.form.manufacturer')"
                :value="props.value"
                v-on="props.events"
                type="text"
              />
        ...
        <v-flex xs12>
          <f-field
            name="dosage"
            :validate="validate('error.required.dosage', required)"
          >
            <template slot-scope="props">
              <v-textarea
                :name="props.name"
                :label="$t('page.record.form.dosage')"
                :rules="checkError(props.meta)"
                :value="props.value"
                v-on="props.events"
                type="text"
  ...
  watch: {
    ...
    entity (value) {
      ...
      this.formConfig.initialize({
        ...
        generic_name: value.generic_name || null,
        factory_name: value.factory_name || null,
