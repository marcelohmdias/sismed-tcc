...
import AppProfileContactDialog from '@/views/profile/ProfileContactDialog'

const actions = mapActions({
  deleteContact: 'patient/DELETE_CONTACT',
  saveContact: 'patient/SAVE_CONTACT'
})

const states = mapState({
  opened: (state) => state.patient.dialogContact
})

export default {
  name: 'AppPatientContact',
